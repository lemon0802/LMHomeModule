...
Pod::Spec.new do |s|
  ...
  s.description  = <<-DESC
                    this is LMHomeModule
                   DESC

  s.homepage     = "https://github.com/lemon0802/LMHomeModule"
  ...
  s.source       = { :git => "https://github.com/lemon0802/LMHomeModule.git", :tag => s.version.to_s }
  ...
  s.source_files  = "LMHomeModule/LMHomeModule/**/*.{h,m}"
