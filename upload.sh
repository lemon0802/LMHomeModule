...
VersionString=`grep -E 's.version.*=' LMHomeModule.podspec`
...
cd ~/.cocoapods/repos/LMBHPrivatePod && git pull origin master && cd - && pod repo push LMBHPrivatePod LMHomeModule.podspec --verbose --allow-warnings --use-libraries
